...
# a = 4
# b = 1
print(lst) # prediction = [4, [1, 8]]
# actual = [4, [3, 8]]
# because the list object was changed in memory, not the value assigned to a


# Problem 4
# One of the most frequently used real-world string operations is 
# that of "string substitution," where we take a hard-coded string and 
...
for key, values in munsters.items():
    print(f"{key} is a {values['age']}-year-old {values['gender']}.")
